...
<p align="center">
  ...
  <a href="https://github.com/JinSooo/rynoa/releases/download/v1.0.0-beta.9/Rynoa-1.0.0-beta.9.dmg"><strong>下载 Mac 版</strong></a> ·
  <a href="HELP.md">使用指南</a> ·
  <a href="https://github.com/JinSooo/rynoa/issues/new/choose">反馈问题</a>
</p>

<p align="center">免费测试版 · macOS 14+ · Apple Silicon / Intel<br />当前版本 v1.0.0-beta.9</p>
...
1. [下载 Rynoa DMG](https://github.com/JinSooo/rynoa/releases/download/v1.0.0-beta.9/Rynoa-1.0.0-beta.9.dmg)，升级前先退出旧版。
...
- [版本说明](https://github.com/JinSooo/rynoa/releases/tag/v1.0.0-beta.9) · [完整变更记录](CHANGELOG.md)
